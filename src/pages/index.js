...
export default (() => {
	return <Theme theme={theme}>
			...
			<Stack>
				<StackItem width="50%" lg-width="100%">
					<Override
						...
						margin-right="-20%"
						padding-bottom="120%"
						background="url(https://uploads.quarkly.io/5fab6b49b1c8af001eb50437/images/RB9lEF.png?v=2020-11-11T05:01:04.836Z) 50% 15%/cover"
						lg-margin-right="0"
				...
				<StackItem width="50%" lg-width="100%">
					...
					<Text as="p" margin="16px 0" font="--base" max-width="400px">
						<br />
						<br />
						Gul - a mythical creature and folklore character, a werewolf in Arabian, Persian and Turkic mythology. Usually depicted as a creature with a hideous appearance and donkey hooves that do not disappear during any transformations.{"\n\n"}
					</Text>
				</StackItem>
			</Stack>
		</Section>
		<Section
			...
			sm-padding="40px 0"
			position="relative"
			background="linear-gradient(0deg,rgba(25, 30, 34, 0.8) 0%,rgba(0,0,0,0) 21%,rgba(25, 30, 34, 0.8) 100%),--color-darkL2 url(https://images.unsplash.com/photo-1547619292-240402b5ae5d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=975&q=80)"
		>
			<Stack>
				<StackItem width="50%" md-width="100%">
					...
					<Box padding="0 0 0 64px" margin="64px 0 0 0" max-width="360px" position="relative">
						...
						<Text as="p" margin="6px 0" font="--headline3">
							+1 (234) 666-66-66            +1 (234) 666-66-66
						</Text>
					</Box>
					<Box
						padding="0 0 0 64px"
